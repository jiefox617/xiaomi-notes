 ...
 *
 * 【类功能】
 * 统一管理笔记APP中所有样式资源：背景颜色、字体大小、列表项背景、小部件背景
 *
 * 【类间关系】
 * - 被NoteEditActivity调用：获取编辑页背景和字体样式
 * - 被NotesListItem调用：获取列表项背景
 * - 被NoteWidgetProvider调用：获取小部件背景
 */
public class ResourceParser {
    ...
    public static int getDefaultBgId(Context context) {
        boolean randomBg = PreferenceManager.getDefaultSharedPreferences(context)
    ...
    public static class WidgetBgResources {
        private static final int[] BG_2X_RESOURCES = new int[]{
        ...
        public static int getWidget2xBgResource(int id) { return BG_2X_RESOURCES[id]; }
        public static int getWidget4xBgResource(int id) { return BG_4X_RESOURCES[id]; }
    }
    ...
    public static class TextAppearanceResources {
        private static final int[] TEXTAPPEARANCE_RESOURCES = new int[]{
